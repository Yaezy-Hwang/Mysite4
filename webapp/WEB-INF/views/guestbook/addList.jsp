	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="guestbook">
				...
				<c:forEach items="${gList}" var="book">
					<table class="guestRead">
						...
						<tr>
							...
							<td>${book.name}</td>
							<td>${book.date}</td>
							<td><a href="${pageContext.request.contextPath}/guestbook/deleteForm?no=${book.no}">[삭제]</a></td>
						</tr>
						<tr>
							<td colspan=4 class="text-left">${book.content}</td>
						</tr>
					</table>
				</c:forEach>
				<!-- //guestRead -->
