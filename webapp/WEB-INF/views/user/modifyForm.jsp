			...
			<div id="user">
				<div id="modifyForm">
					<form action="${pageContext.request.contextPath}/user/modify" method="post">
						...
						<!-- 비밀번호 -->
						<div class="form-group">
							<input type="hidden" name= "no" value= "${authUser.no}"> <!-- no값 넘기기 -->
						...
						<div class="form-group">
							...
							<c:if test= "${authUser.gender eq 'male'}">
								...
								<input type="radio" id="rdo-male" name="gender" value="${authUser.gender}" checked= "checked"> 
								
								<label for="rdo-female">여</label> 
								<input type="radio" id="rdo-female" name="gender" value="${authUser.gender}" > 
							</c:if>
							
							<c:if test= "${authUser.gender eq 'female'}">
								<label for="rdo-male">남</label> 
								<input type="radio" id="rdo-male" name="gender" value="${authUser.gender}"> 
								
								<label for="rdo-female">여</label> 
								<input type="radio" id="rdo-female" name="gender" value="${authUser.gender}"  checked= "checked"> 
							</c:if>
